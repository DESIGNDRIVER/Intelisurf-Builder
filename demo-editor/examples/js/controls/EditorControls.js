...
THREE.EditorControls = function ( object, domElement ) {
	...
	this.pan = function ( delta ) {
		...
		var distance = editor.camera.position.distanceTo( center );

		delta.multiplyScalar( distance * scope.panSpeed );
		delta.applyMatrix3( normalMatrix.getNormalMatrix( object.matrix ) );

		editor.camera.position.add( delta );
		center.add( delta );
	...
	this.zoom = function ( delta ) {
		...
		delta.applyMatrix3( normalMatrix.getNormalMatrix( editor.camera.matrix ) );
	...
	this.rotate = function ( delta ) {
		//console.log(object);
		//console.log(editor.camera);
		vector.copy(editor.camera.position ).sub( center );
		...
		editor.camera.position.copy( center ).add( vector );
