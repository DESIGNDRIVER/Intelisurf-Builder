			...
			case 'wrl':
				...
				case 'jsonc':
					...
					zip.loadAsync(contents).then(function (zip) {
						console.log(zip.files['scene.json']);
						if(zip.files['scene.json']){
							zip.files['scene.json'].async('string').then(function (fileData) {
								var data;
								try {
									data = JSON.parse(fileData);
									FraxGEM.jsonOBJDecoder(data); 
									console.log(data);
