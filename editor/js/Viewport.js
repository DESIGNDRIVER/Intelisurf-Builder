...
var Viewport = function ( editor ) {
	...
	console.log("Viewport.js: Viewport");
	...
	var controls = new THREE.EditorControls( editor.camera, container.dom );
	...
	signals.windowResize.add( function () {
		...
		if (editor.camera instanceof THREE.PerspectiveCamera) {      
			...
			// camera.cameraO.left = container.dom.offsetWidth/ - 2;
			...
			editor.camera.top    =  frustumSize / 2;
			editor.camera.bottom = -frustumSize / 2;
			editor.camera.updateProjectionMatrix();
	...
	// 	if( bool){
	// 		preCamera = editor.camera.clone();
	// 		editor.camera = editor.animationCamera.clone();
	// 		render();
